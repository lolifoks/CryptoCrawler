...
class PostController extends BackendController
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $pictureModel->link = "img/posts/" . $fileName;
            $pictureModel->alt = "blog post";

            $this->model->photo_id = $pictureModel->save();
        ...
        return redirect()->back()->with("error", "An error occured, please try again later". $e->getMessage());
    }
